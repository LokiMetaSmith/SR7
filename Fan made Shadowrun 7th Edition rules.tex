...
\subsubsection{1. Unified Control \& Possession Rules}

The mechanics of taking control of another form---whether through a spiritual \emph{Possession}, a rigger \emph{Jumping-In} to a drone, an AI \emph{Inhabiting} a vehicle, or a user suffering a \emph{BTL Override} (like the Fuchsia Dragon)---follow a unified ruleset:

\begin{itemize}
\item
  \textbf{Control Override:} The host's original stats are suppressed but not destroyed. The possessing entity uses its own mental attributes (\gameterm{LOG}, \gameterm{INT}, \gameterm{WIL}, \gameterm{CHA}). Physical attributes (\gameterm{BOD}, \gameterm{AGI}, \gameterm{REA}, \gameterm{STR}) are typically the host's (with any specific modifiers, such as +3 \gameterm{STR}/\gameterm{BOD} from a Fuchsia Dragon Sprite or a vehicle's frame).
\item
  \textbf{Biofeedback / Damage Sharing:} Because the host (whether meat, drone, or vehicle) is saturated with grey goo or mana, the possessing entity connects to it on a spiritual or deep digital level. If the host takes Physical damage, the possessing entity must resist half of that damage (rounded down) as Stun Biofeedback. This is resisted with \gameterm{WIL} + \gameterm{BOD}.
\item
  \textbf{Destabilization / Destruction Risk (Dumpshock / Extrusion):} If the host's Condition Monitor is filled and it is destroyed while possessed, the possessing entity suffers severe trauma and is violently ejected. They immediately take 6 unresistable Stun damage and suffer a -2 Dice Pool modifier to all actions for (12 - \gameterm{WIL}) minutes.
\item
  \textbf{Initiative Adjustment:} The possessing entity rolls Matrix/Astral Initiative (e.g., Data Processing + Intuition, or \gameterm{REA} + \gameterm{INT}) and gains +1 Initiative Die per level of their connection strength (e.g., Control Rig rating for riggers, or Force/Magic rating for spirits/sprites).
\item
  \textbf{Inhabitation (The Merger):} A temporary possession can violently escalate into a permanent, physical merging creating a dual-natured hybrid.
  \begin{itemize}
    \item \emph{For Spirits:} If a spirit permanently Inhabits a host, the host's personality is destroyed but their physical skills are retained. If the host is a Technomancer, their Resonance stat is permanently destroyed (reduced to 0 due to the Oil and Water rule).
    \item \emph{For BTLs:} For users of Physical Override chips (like the Fuchsia Dragon), if the user takes Physical damage exceeding their Willpower while transformed, the temporary Sprite possession becomes permanent Inhabitation, permanently overwriting the user's mind and turning them into a feral, dual-natured NPC.
  \end{itemize}
\end{itemize}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Magician} & 100 & Access to all magical skills; gains 2x MAG free spells. \\
\textbf{Technomancer} & 80 & Access to Resonance; gains 2x RES Complex Forms. \\
\textbf{Adept} & 75 & Free Power Points equal to MAG rating. \\
\textbf{Aspected Magician} & 50 & Specialized focus; gains 3x MAG free spells. \\
\textbf{Mystic Adept} & 150 & Blends Adept and Magician traits; gains 1x MAG free spells. \\
\end{longtable}
\begin{multicols}{2}
...
Centaur & 3 / 8 & 1 / 6 & 1 / 5 & 3 / 8 & 1 / 6 & 1 / 6 & 2 / 7 & 1 / 6 & 1 / 6 & 45 & \emph{Low-Light Vision, Thermographic Vision, Magic Sense, Galloping Stride, Hooves, Big \& Tall (3)} \\
Dwarf & 3 / 8 & 1 / 6 & 1 / 5 & 3 / 8 & 2 / 7 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 40 & \emph{Thermographic Vision, Toxin Resistance (2), Reach (-1)} \\
Giant & 4 / 9 & 1 / 5 & 1 / 5 & 7 / 12 & 1 / 6 & 1 / 5 & 1 / 5 & 1 / 5 & 1 / 6 & 65 & \emph{Built Tough (2), Reach (+3), Big \& Tall (2)} \\
Gnome & 1 / 4 & 2 / 7 & 1 / 6 & 1 / 4 & 2 / 7 & 2 / 7 & 1 / 6 & 1 / 6 & 1 / 6 & 10 & \emph{Thermographic Vision, Arcane Arrester (4), Neoteny, Reach (-2)} \\
Elf & 1 / 5 & 2 / 7 & 2 / 7 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 3 / 8 & 1 / 6 & 25 & \emph{Low-Light Vision, Reach (+1)} \\
Hobgoblin & 3 / 8 & 1 / 6 & 2 / 7 & 2 / 7 & 1 / 6 & 1 / 5 & 2 / 7 & 1 / 5 & 1 / 6 & 20 & \emph{Low-Light Vision, Fangs, Keen-Eared, Poor Self Control (Vindictive)} \\
Nocturna & 1 / 5 & 3 / 8 & 1 / 6 & 1 / 5 & 1 / 6 & 1 / 6 & 2 / 7 & 2 / 7 & 1 / 6 & -15 & \emph{Night Vision, Keen-Eared, Allergy (Sunlight, Moderate), Nocturnal} \\
Ogre & 4 / 9 & 1 / 6 & 1 / 5 & 3 / 8 & 2 / 7 & 1 / 6 & 1 / 6 & 1 / 4 & 1 / 6 & 30 & \emph{Low-Light Vision, Built Tough (1), Ogre Stomach, Human-Looking} \\
Ork & 4 / 9 & 1 / 6 & 1 / 6 & 3 / 8 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 75 & \emph{Low-Light Vision, Built Tough (2), Reach (+1)} \\
Troll & 5 / 10 & 1 / 6 & 1 / 5 & 5 / 10 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 1 / 6 & 125 & \emph{Thermographic Vision, Built Tough (3), Dermal Deposits, Reach (+2), Big \& Tall (1)} \\
Satyr & 2 / 7 & 1 / 6 & 2 / 7 & 2 / 7 & 1 / 6 & 1 / 6 & 1 / 6 & 2 / 7 & 1 / 6 & 45 & \emph{Low-Light Vision, Built Tough (1), Satyr Legs, Hooves} \\
\end{longtable}
\begin{multicols}{2}
...
\textbf{Spellcasting:} Casting a spell requires \textbf{1 Action}.
...
\textbf{Reckless Spellcasting:} Casting a spell can be done as a Free Action (costing 0 Actions), referred to as \textbf{Reckless Spellcasting}, but the Drain Value is increased by \textbf{+3}.
...
\textbf{Reality Warper} - 20 Karma\\
A character with \textit{Reality Warper} blurs the lines between Resonance and Mana, allowing them to affect the physical world with matrix actions or vice-versa under certain conditions (GM discretion).\\
...
additional Initiative Die and two additional Actions. Incompatible with
...
\textbf{Delusion} - 5 Karma per Level (Max 4)\\
...
weapons. If dual wielding firearms this Action can be used to fire
...
via this Action to flip the giggle switch}.
...
Shiawase Arms Hearth Protector & 5 & 5P & 0 & SA & 1 & Near & 12(c) & 4(R) & 1.00 & 400\textyen \\
...
\subsection{2. Conjuring \& Summoning Spirits}\label{conjuring-summoning-spirits}}

Magicians can summon Canonical Spirits (Elementals, Spirits of Man, etc.) from the Astral Plane to aid them.

\textbf{Summoning Mechanics:}
\begin{itemize}
\tightlist
\item
  \textbf{The Test:} To summon a spirit, the Magician rolls \textbf{Conjuring + Magic} versus the Spirit's \textbf{Force}.
\item
  \textbf{Net Hits:} Each net hit generated by the Magician equals one ``Service'' the spirit owes.
\item
  \textbf{Drain:} The Magician must resist Summoning Drain equal to twice the Spirit's hits on the opposed test. This Drain is resisted with Willpower + Tradition Attribute. If the Force of the spirit exceeds the Magician's Magic Rating, the Drain is Physical Damage instead of Stun Damage.
\item
  \textbf{Services:} Services can include participating in combat, sustaining a spell, concealing the party, or using a specific spirit power. A summoned spirit remains bound to the physical plane until its services are exhausted, or until the next sunrise or sunset, whichever comes first.
\item
  \textbf{Glitches:} A Glitch on a summoning test means the spirit demands an immediate offering (Karma or an item) before serving. A Critical Glitch results in the spirit manifesting as hostile and immediately attacking the summoner.
\end{itemize}

\hypertarget{adept-powers-metamagic}{%
\subsection{3. Adept Powers \& Metamagic}\label{adept-powers-metamagic}}
...
\subsection{4. Ritual Spellcasting}\label{ritual-spellcasting}}
...
\textbf{The Ritual Process:}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Choose Leader and Assistants:} A single Leader directs the spell. Other participants act as Assistants.
\item
  \textbf{Determine Force:} The Force of the ritual must be chosen, limited by the Leader's Magic Rating and the Lodge's Rating.
\item
  \textbf{Establish Link:} The material link provides the sympathetic connection to the target across distance.
\item
  \textbf{Execution:} The ritual takes (Force) hours to complete. A teamwork test is made, and the total hits dictate the ritual's effectiveness.
\end{enumerate}
...
program is a Free Action. Programs act as localized rules-overrides or
...
\textbf{Tar-Baby} & Hacking & If a target successfully defends against your Matrix Action, they suffer an immediate -2 dice pool penalty to their next action as their persona is bogged down in sticky code. \\
\textbf{Agent (Rating 1-6)} & Autonomous & An autonomous program. Requires a Complex Action to deploy. Rolls (Rating x 2) for its own independent Matrix actions on your initiative pass. \\
\textbf{Sprite (Wild)} & Autonomous & Similar to an Agent, but volatile. Rolls (Rating x 2) for actions, but half its dice are always Wild Dice. If a Sprite rolls a 1 on a Wild Die, it goes rogue and targets the nearest entity (including you). \\
\end{longtable}
\begin{multicols}{2}
...
\paragraph{3. Host Architecture \& Intrusion Countermeasures (IC)}\label{host-architecture-ic}
...
\textbf{Design Doc: Rigging in the 6th World}
...
\textbf{Jumping In (Control Rig Integration)}\\
A Rigger with a Control Rig (Rating 1-3) can ``jump into'' a
nanite-infused vehicle equipped with a Rigger Interface. This acts as a
DNI Hot-Sim connection, merging the Rigger's consciousness with the
vehicle's pseudo-Essence. This functions mechanically identically to the
Possession rules for Spirits and Sprites:

\begin{itemize}
\tightlist
\item
  \textbf{Control Override:} The Rigger suppresses the vehicle's base
  pilot program.
\item
  \textbf{Dice Pool Bonus:} The Rigger adds their Control Rig rating to
  all Vehicle skill checks (Piloting, Gunnery, Sensors).
\item
  \textbf{Threshold Reduction:} The Threshold for any Vehicle test is
  reduced by the Control Rig rating (to a minimum of 1).
\item
  \textbf{Initiative:} While jumped in, the Rigger uses Matrix Initiative
  (Data Processing + Intuition) and gains +1 Initiative Die per level of
  their Control Rig.
\end{itemize}

\textbf{Bio-Feedback \& Destabilization}\\
Because the vehicle is saturated with grey goo, it possesses a
pseudo-Essence that the Rigger connects to on a spiritual level. Just
like the Possession rules:

\begin{itemize}
\tightlist
\item
  \textbf{Damage Sharing:} If the vehicle takes Physical damage, the
  Rigger must resist half of that damage (rounded down) as Stun
  Biofeedback. This is resisted with \texttt{WIL\ +\ BOD}.
\item
  \textbf{Destabilization Risk (Dumpshock):} If the vehicle's Condition
  Monitor is filled and it is destroyed while the Rigger is jumped in,
  the Rigger suffers violent extrusion and Dumpshock, immediately taking
  6 unresistable Stun damage and suffering a -2 Dice Pool modifier to
  all actions for (12 - WIL) minutes.
\end{itemize}

\textbf{Chase Combat}\\
Chases are high-speed engagements where kinetic energy limits the
standard rules of physics. It can represent vehicular chases or
warp-speed maneuvers in the Astral/Matrix. Abstract exact speeds into
Range Bands: Close, Short, Medium, Long, and Extreme.

\begin{itemize}
\tightlist
\item
  \textbf{The Chase Turn:} At the start of a Combat Round where a chase
  is occurring, all participating drivers make an Opposed
  \texttt{Pilot\ +\ Reaction} test. The net hits determine if a vehicle
  moves up or down a Range Band relative to their target.
\item
  \textbf{Chase Maneuvers:} Drivers can spend their Complex actions
  during their Initiative pass to attempt specific maneuvers:

  \begin{itemize}
  \tightlist
  \item
    \emph{Catch Up / Break Away:} An opposed Pilot test to force a shift
    in Range Band.
  \item
    \emph{Evade:} The driver focuses entirely on defense, adding their
    Vehicle's Handling rating to their Defense Pool against incoming
    attacks for the round.
  \item
    \emph{Ram:} An opposed Pilot test. If successful, both vehicles take
    Physical damage equal to the ramming vehicle's Body + Speed. However,
    the vehicle with the higher (Body + Armor) resists the damage with
    double their dice pool, and halves the final damage taken (ensuring
    heavier vehicles win crashes).
  \item
    \emph{Cut Off:} Attempted at Close or Short range. An opposed Pilot
    test to aggressively position in front of the target, forcing them to
    make an immediate Crash Test.
  \end{itemize}
\end{itemize}

\hypertarget{vehicle-modifications}{%
\paragraph{3. Vehicle Modifications}\label{vehicle-modifications}}
...
\paragraph{4. Drone Swarms}
Rather than controlling dozens of drones individually, a rigger or decker can slave multiple identical drones into a \textbf{Swarm}. The swarm acts as a single entity in combat, distributing processing power and sensor data to act with lethal synchronization.

\begin{itemize}[nosep]
\item \textbf{Swarm Count:} A swarm tracks its size via a \texttt{swarm\_count} integer (representing the number of active drones in the formation).
\item \textbf{Attack Bonus:} A swarm gains an attack pool bonus equal to \texttt{(+ swarm\_count - 1)}. A swarm of 5 drones gains a +4 bonus to Gunnery or Melee attack rolls.
\item \textbf{Damage Soaking:} Instead of tracking damage for each individual drone, the swarm soaks physical damage collectively. If the swarm takes physical damage that fills its Physical Track, it is not destroyed. Instead, the \texttt{swarm\_count} is reduced by 1 (representing a destroyed drone), and the Physical Track is instantly cleared.
\end{itemize}
...
\emph{Upgrading 'Ware/Decks:} Players may upgrade their existing cyberware, bioware, or cyberdecks by simply paying the difference in Nuyen/Essence cost, representing modular swapping rather than selling at a total loss.
...
\hypertarget{1.-nanite-induced-cyberware-affliction-n.i.c.a.}{%
\paragraph{1. Nanite-Induced Cyberware Affliction (N.I.C.A.)}\label{1.-nanite-induced-cyberware-affliction-n.i.c.a.}}
...
\tightlist
\item
  \textbf{Vector:} Inhalation or prolonged skin contact with highly concentrated, unsanctioned grey goo or feral nanite swarms.
\item
  \textbf{Symptoms:} The body's immune system fails to reject or mistakenly identifies ambient nanites as friendly building materials. The nanites spontaneously begin constructing crude, unintended cybernetic or bioware structures within the host's body using trace minerals from their bloodstream and environment.
\item
  \textbf{Mechanics:}
  \begin{itemize}
  \tightlist
  \item
    \textbf{Incubation:} 1D6 Days after extreme exposure.
  \item
    \textbf{Progression:} Every week, the host must make a Body + Willpower test (Threshold 4).
  \item
    \textbf{Failure:} The host spontaneously develops a random piece of low-grade cyberware or bioware (GM's discretion or roll on a random table). This forced implantation costs the standard Essence but provides the mechanical benefits. However, it is excruciatingly painful, causing 1 box of unhealable Physical damage per week until treated, and the cyberware is often visibly jagged, protruding, or functionally erratic (glitching on 1s and 2s).
  \item
    \textbf{Cure:} Requires intensive medical intervention: an Extended Biotech + Logic test (Threshold 16, 1 Day interval) using specialized Nanite Hunters or an Internal Nanite Hive, costing thousands of Nuyen in medical supplies. Alternatively, finding a localized "Null Zone" or EMP-shielded medical ward can halt the progression while surgery is performed to remove the rogue 'ware and restore lost Essence over months of therapy.
  \end{itemize}
\end{itemize}

\hypertarget{2.-healing-mechanics}{%
\paragraph{2. Healing Mechanics}\label{2.-healing-mechanics}}
...
\paragraph{3. Resurrection Mechanics (Echoes of Death)}\label{resurrection-mechanics-echoes-of-death}}
...
\tightlist
\item
  \textbf{Burning Edge (The Classic Survival):} The most common method of cheating death. When a character's Physical Condition Monitor overflows beyond their Body rating, they may permanently burn 1 point of Edge to survive.
  \begin{itemize}
  \tightlist
  \item
    \emph{Mechanics:} The character falls into a comatose state (0 boxes remaining on the Physical track) but stabilizes. They require immediate medical evacuation.
  \item
    \emph{Character Development:} They permanently lose 1 maximum Edge. Players are encouraged to describe a lasting physical or psychological trauma resulting from the near-death experience (e.g., severe cyberware damage, phantom pain, a new phobia).
  \end{itemize}
\item
  \textbf{The Lazarus Protocol (Nanite Reconstruction):} A forbidden, experimental procedure utilized by high-end corp black clinics and desperate shadow-docs. If a body is recovered within 1 hour of death, a concentrated slurry of medical-grade grey goo can be used to violently rebuild the damaged organs.
  \begin{itemize}
  \tightlist
  \item
    \emph{Mechanics:} Costs 250,000¥ and requires a Biotech + Logic {[}10{]} Extended Test (1 Hour interval).
  \item
    \emph{Character Development:} The process consumes a massive amount of the soul's essence, costing a permanent \textbf{-1.0 Essence}. Additionally, the character immediately acquires the \emph{Scrap-Sickness (N.I.C.A.)} negative quality and the \emph{Digital Ghost} quality, as their body is now saturated with semi-feral nanites.
  \item
  ...
  \end{itemize}
\item
  \textbf{Digital Ascension (The Ghost in the Machine):} If a character is killed specifically by biofeedback while connected via Hot-Sim or while jumped into a vehicle/drone, their physical brain boils, but their consciousness can be ``uploaded'' into the Gaiasphere.
  \begin{itemize}
  \tightlist
  \item
    \emph{Mechanics:} The physical body dies permanently. The character is instantly converted into an AI/Digital Entity. They lose all physical attributes (Strength, Agility, Body) but retain mental attributes. Their Essence becomes fixed at 6 (Digital).
  \item
  ...
  \end{itemize}
\item
  \textbf{Cold Storage (The Arcade Revival):} A bizarre, metareal phenomenon where the Gaiasphere attempts to ``re-spool'' a violently deleted consciousness from latent data and ambient nanites, dumping them into a surrogate body constructed from grey goo.
  \begin{itemize}
  \tightlist
  \item
    \emph{Narrative Trigger:} When a character is killed or incapacitated beyond recovery, their consciousness awakes in a surreal, dream-like construct: an empty neon-lit arcade. ``You walk up to an arcade game and there are two quarters on the console. The arcade is titled `ShadowRun'. Turning around there is an exit sign and a bright white door stiletto. Putting in a quarter lets you revive your character.''
  \item
    \emph{Mechanics:} The character is revived, and all physical damage is repaired with gamma-level cyberware. They regain three-fourths (3/4) of their physical and stun damage tracks. However, \textbf{all equipment, weapons, and armor on their person at the time of death are permanently consumed} by the nanite swarm used to rebuild them.
  \item
    \emph{The Cost:} The character immediately ascends to \textbf{Level Three on the Headcase Quintet Scale}.
  \end{itemize}
\end{itemize}

\hypertarget{the-headcase-quintet-levels}{%
\paragraph{The Headcase Quintet Levels}\label{the-headcase-quintet-levels}}
...
\tightlist
\item
  \textbf{Level One (Initial Infection):} The infection vector was usually through a simsense rig (e.g., viewing corrupted, anomalous video feeds). The character receives involuntary Matrix Perception, un-natural physical regeneration, and access to basic CFD powers.
\item
  \textbf{Level Two (The Cohort):} The character gains total, unbidden awareness of other Quintet members---their location, thoughts, presence, and abilities. They possess permanent Matrix perception and the complete set of CFD powers. They become, essentially, a Sense8 cohort.
\item
  \textbf{Level Three (A Bridge Too Far):} The characters begin experiencing active personality damage, bleeding, and merging. This level is usually only reached if a member leaves, becomes incapacitated, dies, or is resurrected via \emph{Cold Storage}. Characters at this level receive roleplaying bonuses for voluntarily picking flaws and negative attributes to compensate for their deteriorating, shared mental condition.
\end{itemize}
...
\paragraph{1. Secure Comms \&
Street Cred}\label{secure-comms-street-cred}}
...
\paragraph{2. Influence Resolution (Advanced Social Conflict)}\label{influence-resolution-advanced-social-conflict}}
...
\begin{itemize}
\item
  \textbf{PCs use Influence}, measuring their sway over the target.
\item
  \textbf{NPCs use Resolve}, measuring their resistance to the PC's influence.
\item
  The conflict ends when either \textbf{Influence equals the NPC's Willpower} (the NPC agrees, yields, or believes the lie) or \textbf{Resolve equals the PC's Willpower} (the NPC becomes intractable and no further social attempts will work).
\end{itemize}

\textbf{Charisma-Related Tests:}
Players make an opposed Charisma-related test (e.g., Con, Negotiation, Intimidation) vs the NPC's resisting attribute.
\begin{itemize}
\item
  \emph{Resisting Social/Manipulation:} Willpower + Charisma
\item
  \emph{Resisting Logic/Evidence:} Willpower + Logic
\item
  \emph{Resisting Intimidation/Force:} Willpower + Strength
\end{itemize}

If the PC wins, they gain \textbf{1 Influence + 1 per net hit}.

If the NPC wins, they gain \textbf{1 Resolve + 1 per net hit}.

\emph{Note: A tie is a success with no net hits, granting 1 point to the winner.}

\textbf{Social Modifiers:}
\begin{itemize}
\item
  \textbf{Attitude:} Ranges from +3 (Friendly/Aligned Objectives) to -3 (Hostile/Opposed Objectives). This modifies the PC's dice pool only.
\item
  \textbf{Leverage:} Ranges from +1 (Slight Advantage) to +3 (Serious Advantage, like hard evidence or a gun to their head). This modifies either party's dice pool, depending on who holds the leverage.
\item
  \textbf{Hopepunk / Notoriety:} Against digital or awakened entities, a character's Street Cred (Hopepunk) or Notoriety may act as permanent Leverage (+/-).
\end{itemize}

\textbf{Using Edge in Social Conflict:}
Just like physical combat, Edge is vital in social conflicts.
\begin{itemize}
\item
  \textbf{Push the Limit:} Spend 1 Edge to add Edge rating to the roll and apply the Rule of 6 (explosive 6s).
\item
  \textbf{Second Chance:} Spend 1 Edge to reroll all non-hits (especially useful for saving a critical argument).
\item
  \textbf{Seize the Initiative (Get Revenge):} An NPC may spend Edge to immediately take a free Charisma-related test against a character who just tested them, simulating a counteroffer, counterthreat, or red herring.
\item
  \textbf{Assist (Push Forward):} A character who fails a test may spend 1 Edge to convert any hits they did get into a Teamwork bonus for an ally's immediate subsequent test (the classic ``Good Cop/Bad Cop'' routine).
\end{itemize}
...
\tightlist
\item
  \textbf{Essence Drain:} All HMHVV infected must consume Essence to survive. Failure to consume at least 1 Essence per month results in physical degradation, leading to death or becoming mindless ferals.
\item
  \textbf{Dual Natured:} All Infected are active on both the physical and astral planes simultaneously.
\item
  \textbf{Infection Transfer:} Biting, clawing, or Essence Drain transfers the HMHVV virus. Victims must resist with Body + Willpower.
\end{itemize}

\textbf{The Zkazena Ghoul (Strain III)}
...
\tightlist
\item
  \textbf{Attributes:} BOD +2 	extbar{} STR +1 	extbar{} REA +1 	extbar{} WIL +1 	extbar{} CHA -2 	extbar{} INT -1
\item
  \textbf{Qualities:} Natural Weapon (Claws/Bite: DV 4P, AP -1), Dietary Requirement (Metahuman Flesh), Reduced Sense (Blindness), Enhanced Senses (Smell, Hearing).
\item
  \textbf{Zkazena Adaptation:} ``Containment Surge Frenzy'' - When ambient magic spikes, these ghouls enter a frenzied state, gaining +1 Die on physical actions and ignoring the first box of damage on any track.
\end{itemize}

\textbf{The Ancient Vampire (Strain I)}
...
\tightlist
\item
  \textbf{Attributes:} BOD +1 	extbar{} AGI +1 	extbar{} STR +2 	extbar{} WIL +2 	extbar{} LOG +1 	extbar{} CHA +2
\item
  \textbf{Qualities:} Essence Drain, Regeneration (Heals 1 physical damage per turn, disabled by sunlight or wood), Severe Allergy (Sunlight).
\item
  \textbf{Magic:} Many vampires are Awakened, retaining or gaining Magician status upon infection.
\end{itemize}
...
\item
  ...
  expensive Nanite-Buster rounds. Let them use 1 Action to swap
...
\item
  ...
  entities.
\item
  \textbf{Buying Contacts:} During downtime, players may spend Karma to purchase important NPCs they've helped as Contacts. The Karma cost is equal to the desired Connection Rating x 3.
\end{itemize}
...
\subsubsection{XV. ADVANCED TACTICAL COMBAT}\label{xv.-advanced-tactical-combat}}
...
\paragraph{1. The "Chunky Salsa" Effect (Explosives in Confined Spaces)}\label{the-chunky-salsa-effect-explosives-in-confined-spaces}
Explosions in enclosed environments are significantly deadlier due to shockwave reflection off hard surfaces.
\begin{itemize}[nosep]
    \item \textbf{The Rule:} When a grenade or explosive device detonates in an enclosed area (such as a small room, a corridor, or behind \textbf{Heavy Cover}), the blast wave rebounds. To simulate this efficiently without calculating exact geometric angles, the explosive's Base Damage is \textbf{multiplied by 2} against all targets in that specific confined zone before applying blast drop-off modifiers.
    \item \textbf{Collateral:} The structure itself takes this doubled damage, potentially destroying the cover entirely and exposing the targets for the next Combat Turn.
\end{itemize}

\paragraph{2. Cover Modifiers}\label{cover-modifiers}
Cover physically stops bullets and disrupts AR targeting algorithms.
\begin{itemize}[nosep]
    \item \textbf{Light Cover:} (e.g., foliage, chain-link fences, thin drywall). Grants +1 to the Defense Pool.
    \item \textbf{Medium Cover:} (e.g., ruined cars, thick wooden doors, chat piles). Grants +2 to the Defense Pool.
    \item \textbf{Heavy Cover:} (e.g., reinforced concrete, plasteel barriers, banking counters). Grants +4 to the Defense Pool. If an explosive detonates on the \emph{same side} as the combatant, the Chunky Salsa effect applies.
\end{itemize}

\paragraph{3. Environmental \& Initiative Modifiers}\label{environmental-initiative-modifiers}
The battlefield itself is a weapon.
\begin{itemize}[nosep]
    \item \textbf{Lighting \& Visibility:} Dim light, smoke, or heavy rain imposes a flat -1 to -3 penalty to all Attack and Perception dice pools.
    \item \textbf{Background Count / Noise:} Dense AR noise or magical voids impose a flat penalty to Matrix/Magic actions (e.g., -1 to -4) and force the use of \textbf{Wild Dice} for those tests.
    \item \textbf{Superior Positioning:} Taking the "High Ground" or flanking an opponent grants a flat \textbf{+1 Initiative Die} for the duration of the encounter, reflecting the tactical advantage.
    \item \textbf{Surprise:} If a combatant successfully ambushes a target, they receive a \textbf{+2 bonus to their Base Initiative Score} for the first Combat Turn.
\end{itemize}
