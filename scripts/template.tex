...
\ifPDFTeX
  % If using pdflatex, we want a classic Serif body font (to emulate Friz Quadrata)
  % and Helvetica/Sans-serif for headings.
  \usepackage{charter} % Beautiful classic serif body font that resembles Friz Quadrata Std
  \usepackage{helvet}
  % Maintain normal serif body (Charter) rather than overriding familydefault to sfdefault
  \newcommand{\bodyfont}{\rmfamily}
  \newcommand{\headingfont}{\sffamily\bfseries}
  \newcommand{\subheadingfont}{\sffamily\bfseries}
  \newcommand{\commentfont}{\sffamily}
  \newcommand{\commentfontbold}{\sffamily\bfseries}
\else
  % XeLaTeX / LuaLaTeX: We load the downloaded authentic fonts directly via fontspec
  \usepackage{fontspec}
  \setmainfont[
    Path=fonts/,
    Extension=.otf,
    UprightFont=FrizQuadrataStd,
    BoldFont=FrizQuadrataStd,
    ItalicFont=FrizQuadrataStd
  ]{FrizQuadrataStd}
  \newcommand{\bodyfont}{\rmfamily}
  \newfontfamily\headingfont[Path=fonts/,Extension=.otf]{Aachen-Bold}
  \newfontfamily\subheadingfont[Path=fonts/,Extension=.ttf]{FuturaBT-Medium}
  \newfontfamily\commentfont[Path=fonts/,Extension=.ttf]{AvantGarde-Book}
  \newfontfamily\commentfontbold[Path=fonts/,Extension=.ttf]{AvantGarde-BoldObl}
\fi
...
\newcommand{\gameterm}[1]{\bodyfont\textbf{#1}}
...
\titleformat{\section}[block]
  {\normalfont\LARGE\headingfont\color{matrixblue}\MakeUppercase}
  {\thesection}{1em}{}
  [\vspace{0.5ex}\color{matrixblue}\titlerule\vspace{0.25ex}\color{sraccent}\titlerule]
\titlespacing*{\section}{0pt}{1.5ex plus 1ex minus .2ex}{1ex plus .2ex}

\titleformat{\subsection}[block]
  {\normalfont\Large\subheadingfont\color{srdark}\MakeUppercase}
  {\thesubsection}{1em}{}
...
\newtcolorbox{jackpoint}[2][]{
    ...
    fonttitle=\bfseries\commentfontbold\small,
    fontupper=\commentfont,
    title={>> USER: #2 <<},
